...
sudo -H -u rammy bash -i -c "jupyter notebook --port 8888 --no-browser --ip=0.0.0.0 --NotebookApp.token='' --NotebookApp.password=$npPasswd --NotebookApp.noteboook_dir=/home/rammy/ &" &
