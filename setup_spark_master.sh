...
sudo -H -u rammy bash -c '/opt/software/spark-3.0.3-bin-hadoop3.2/bin/spark-class org.apache.spark.deploy.master.Master --ip 192.168.1.1 --port 7077 --webui-port 8080 >> /opt/software/master.log &' &
